...
version = 1.0.0
requirements = python3,kivy,pillow,aiohttp,async_timeout,aiohappyeyeballs,aiosignal,attrs,frozenlist,multidict,propcache,yarl,idna,charset_normalizer,cchardet,android,pyjnius,openssl

...
version = 1.0.0
requirements = python3,kivy,pillow,aiohttp,async_timeout,aiohappyeyeballs,aiosignal,attrs,frozenlist,multidict,propcache,yarl,idna,charset_normalizer,requests,urllib3,certifi,android,pyjnius,openssl
